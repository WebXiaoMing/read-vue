<template>
  <div class="hot-list" v-if="list.length">
    ...
    <div class="hot-book-list" v-for="item in list">
        ...
        <div class="top-book-right">
          ...
          <div class="top-book-info">
            ...
            <div class="book-info">
              ...
              <span class="book-genre">{{item.minClass}}</span>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    watch: {
      list (newVal) {
        let id = this.title === '热门追更' ? newVal[4]._id : newVal[5]._id
        getRankList(id).then(res => {
          this.list = res.data.ranking.books.map(item => book(item)).slice(0, 3)
        })
      }
    }
  }
